...
class Post extends React.Component {
  ...
  render(){
    return(
      <div className={`post ${this.state.clicked ? ' clicked-background': ''}`} onClick={this.onClick}>
       ...
       <div className='post-content'>
         <div className='post-headline'>
           ...
           <h1 className='post-title'>{(this.props.headline ? this.props.headline : `${this.props.type} Post`).headlineShorten()}</h1>
